defmodule Rinha.PessoasTest do
  use Rinha.DataCase
  ...
  describe "pessoas" do
    ...
    test "create_pessoa/1 with valid data creates a pessoa" do
      valid_attrs = %{stack: ["option1", "option2"], apelido: "some apelido", nome: "some nome", nascimento: ~D[2025-10-02]}
      ...
      assert pessoa.nascimento == ~D[2025-10-02]
    end
    ...
    test "update_pessoa/2 with valid data updates the pessoa" do
      pessoa = pessoa_fixture()
      update_attrs = %{stack: ["option1"], apelido: "some updated apelido", nome: "some updated nome", nascimento: ~D[2025-10-03]}
      ...
      assert pessoa.nascimento == ~D[2025-10-03]
    end
